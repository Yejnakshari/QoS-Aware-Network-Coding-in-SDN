print("**********************************************")
print("Project Title IMPLEMENTING NETWORK CODING TECHNIQUES ON AN SDN (SOFTWARE DEFINED NETWORK) ")
print("**********************************************")
print()
...
# Parameters
num_nodes = int(input("Enter num of Nodes: "))
...
# Train the model
history = model.fit(X_train, y_train, epochs=2, batch_size=20, validation_split=0.2)
...
for i in range(len(metrics)):
    plt.text(i - bar_width/2, values_in    [i] + 0.05, round(values_inddos[i], 4), ha='center', va='bottom', color='black')
